...
2. 禁用乐鑫工程中的火山组件。
   ...
   ```bash
   git apply $ADF_PATH/examples/ConversationalAI-Embedded-Kit-2.0/examples/high_quality_solution/espressif/0001-feat-disable-volc-esp-libs.patch
   ```
3. 修复乐鑫按键问题
   ...
   ```bash
   git apply $ADF_PATH/examples/ConversationalAI-Embedded-Kit-2.0/examples/high_quality_solution/espressif/0001-esp_peripherals-Support-ADC-API-of-IDF-5.x-in-adc_bu.patch
   ```
